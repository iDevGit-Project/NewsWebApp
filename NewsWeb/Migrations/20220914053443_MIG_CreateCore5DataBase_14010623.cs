...
{
    public partial class MIG_CreateCore5DataBase_14010623 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenderSex = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abstract = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TNews", x => x.NewsId);
                    table.ForeignKey(
                        name: "FK_TNews_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TNews_TCategory_CategoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TNews_CategoryID",
                table: "TNews",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_TNews_UserID",
                table: "TNews",
                column: "UserID");
        }
